...
class FieldType extends Addon
{
    ...
    public function getPresenter()
    {
        ...
        return $this->manager->getContainer()->make($this->presenter, ['object' => $this]);
    }
    ...
    public function getModifier()
    {
        ...
        $modifier = $this->manager->getContainer()->make($this->modifier);
    ...
    public function getAccessor()
    {
        ...
        $accessor = $this->manager->getContainer()->make($this->accessor);
    ...
    public function getSchema()
    {
        ...
        return $this->manager->getContainer()->make($this->schema, ['fieldType' => $this]);
    }
    ...
    public function getParser()
    {
        ...
        return $this->manager->getContainer()->make($this->parser, ['fieldType' => $this]);
    }
    ...
    public function getQuery()
    {
        ...
        return $this->manager->getContainer()->make($this->query, ['fieldType' => $this]);
    }
    ...
    public function getCriteria(Builder $query)
    {
        ...
        return $this->manager->getContainer()->make(
            $this->criteria,
            [
                'fieldType' => $this,
                'query' => $query,
